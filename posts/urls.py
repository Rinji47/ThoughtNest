...
urlpatterns = [
	...
	path('posts/<int:pk>/delete/', views.admin_delete_post, name='post_delete'),
	...
	path('admin/category/create-inline/', views.admin_create_category, name='admin_create_category'),
